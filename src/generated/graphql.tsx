...
export type GetCompanyNameListQuery = {
  __typename?: "Query";
  companylist?: Maybe<Array<{ __typename?: "Company"; name: string }>>;
};
 ...
 * });
 */
export function useGetCompanyNameListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetCompanyNameListQuery,
    GetCompanyNameListQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetCompanyNameListQuery,
    GetCompanyNameListQueryVariables
  >(GetCompanyNameListDocument, options);
}
export function useGetCompanyNameListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetCompanyNameListQuery,
    GetCompanyNameListQueryVariables
  >
...
export type GetCompanyNameListQueryHookResult = ReturnType<
  typeof useGetCompanyNameListQuery
>;
export type GetCompanyNameListLazyQueryHookResult = ReturnType<
  typeof useGetCompanyNameListLazyQuery
>;
export type GetCompanyNameListQueryResult = Apollo.QueryResult<
  GetCompanyNameListQuery,
  GetCompanyNameListQueryVariables
>;
